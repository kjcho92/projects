...
def extract_tensors_from_checkpoint_file(
    filename, output_folder="weights", net_name=None
):
...
checkpoint_file = os.path.join(MODEL_DIR, MODEL_SUBDIR_MOBILE, "model.ckpt-30000")
extract_tensors_from_checkpoint_file(
